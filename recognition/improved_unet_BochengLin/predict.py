...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default=r"C:\COMP3710\PatternAnalysis-2025\recognition\improved_unet_BochengLin\best_model.pth", help="Path to model checkpoint")
